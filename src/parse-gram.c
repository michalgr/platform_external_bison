...
#line 920 "src/parse-gram.c"
        break;

    case 28: /* "%name-prefix"  */
#line 228 "src/parse-gram.y"
      { fputs (((*yyvaluep).PERCENT_NAME_PREFIX), yyo); }
#line 926 "src/parse-gram.c"
        break;
